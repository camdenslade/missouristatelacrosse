// src/Women/Local/Pages/Recruitment/Submissions.jsx
...
export default function WRecruitmentSubmissions({ userRole }) {
  ...
  useEffect(() => {
    const fetchSubmissions = async () => {
      ...
      try {
        const snapshot = await getDocs(collection(db, "recruitmentw"));
  ...
  const handleDelete = async (id) => {
    ...
    try{
      await deleteDoc(doc(db, "recruitmentw", id));
